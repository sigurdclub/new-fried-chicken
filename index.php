    ...
    <div class="content-wrapper" style="background-color: #FFDFAF;">
        ...
        <div style="display: flex; justify-content: left;">
            ...
            <div class="card" style="width: 18rem;background-color: #F2BB7B; ">
                <img style="padding: 14px;" src="./assets/images/imgbin_hamburger-fried-chicken-fast-food-french-fries-png.png" class="card-img-top" alt="..." height="290pc">
                <div class="card-body">
                    <h2 style="text-align: center; color: black;">Ayam</h2>
                </div>
            ...
            <div class="card" style="width: 18rem; background-color: #F2BB7B;">
                <img style="padding: 14px;" src="./assets/images/Vanilla Bean Shortbread Cookies - Nature Nate's.png" height="75%" width="" class="card-img-top" alt="...">
                <div class="card-body">
                    <h2 style="text-align: center; color: black;">Pesanan</h2>
                </div>
            </div>
        </a>
            </div>
    ...
    <footer class="main-footer" style="background-color: #FFDFAF;">
        ...
        <b style="color: black;">@SigurdClub</b><span style="color: black;"> 20.10.21</span>
    </footer>
    </div>
    <!-- ./wrapper -->
