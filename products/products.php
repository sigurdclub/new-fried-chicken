    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 side-text">
        <!-- Brand Logo -->
        <a href="../index.php" class="brand-link" style="background-color:  #F2BB7B;">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
            <a href="#" class="d-block" style="color: black;">Riska</a>
            </div>
        </div>
    ...
    <div class="content-wrapper" style="background-color: #FFDFAF;">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0" style="color: black;">Product </h1>
            </div>
            </div>
        </div>
        
        <a href="tambahproduct.php">
            <button type="button" class="btn btn-product" >Tambah</button>
        </a>
        </div>
        <!-- Last Content -->
